window.onload = function() {
    document.getElementById("nr").oninput = function (){
        ...
        for(var i = 0; i < posts; i++){
            ...
            txt.innerHTML = "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Perspiciatis harum aliquid eos ea! A atque inventore, beatae recusandae commodi placeat tempora, eligendi consectetur laboriosam delectus illo, quia exercitationem. Omnis, esse!";
