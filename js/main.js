...
window.onload = function () {
  document.getElementById("nr").oninput = function () {
    ...
    for (var i = 0; i < posts; i++) { //går sedan igenom en loop för att skapa så många av varje element.
...
function Remove() { // här tar vu bort alla article och länkar.
...
function makeEditable(elem) {
  elem.onclick = function () { // när användaren trycker på dessa elem så kan man redigera texten samt får en border runt.
